...
| Secura | Scan large numbers of webapps for Log4Shell vulnerability | https://www.secura.com/news/check-log4j-vulnerability-with-external-attack-surface-scanning | 
