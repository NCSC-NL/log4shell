...
|:----------------|:----------------|:---------------:|
| Akamai       | Cloud | Mitigtion rule was created adn added to: Kona Rule Set - Any version dated October 29, 2019 or later, Automated Attack Groups - Any version, Adaptive Security Engine - Any version [source](https://www.akamai.com/blog/news/CVE-2021-44228-Zero-Day-Vulnerability) | 
